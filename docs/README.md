...
## Настройка
- **ROLE_RESTRICTIONS_GUIDE.md** - Ролевые ограничения
- **SERVICES_STARTUP_GUIDE.md** - Запуск сервисов
...
- **RETRIEVAL_BENCHMARKS.md** - Метрики RAG

---

**Архив:** `archive/` - устаревшие документы
