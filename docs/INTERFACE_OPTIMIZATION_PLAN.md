...
### Фаза 1: Базовый интерфейс документирования (2-3 дня)

**День 1:**
- [ ] Добавить API эндпоинты для работы с комментариями
- [ ] Реализовать получение списка таблиц с комментариями
- [ ] Реализовать получение колонок таблицы

**День 2:**
- [ ] Добавить форму для COMMENT ON TABLE
- [ ] Добавить форму для COMMENT ON COLUMN
- [ ] Реализовать сохранение комментариев в БД

**День 3:**
- [ ] Добавить статистику и визуализацию
- [ ] Добавить экспорт списка таблиц без комментариев
- [ ] Тестирование
