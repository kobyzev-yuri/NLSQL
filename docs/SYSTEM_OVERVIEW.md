...
- Функции:
  ...
  - 📊 Метрики и бенчмарки retrieval
  - 🔄 Переобучение моделей эмбеддингов
...
**Процесс работы:**
1. Эмбеддинги генерируются через `all-MiniLM-L6-v2`
...
- [ ] Добавление streaming ответов от LLM
- [ ] Кэширование частых запросов
- [ ] Улучшение промптов для специфичных доменов
- [ ] Поддержка JOIN запросов через RAG
